        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="<?= base_url('app/profil') ?>" class="nav-link">
                    <img src="<?= base_url('dist/img/user2-160x160.jpg') ?>" class="user-image img-circle"
                         alt="<?= $_SESSION['nama'] ?>">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2" aria-label="nav">
                <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-legacy" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('app/tender') ?>"
                           class="nav-link <?= in_array($_GET['page'], ['tender', 'tender_detail']) ? 'active' : '' ?>">
                    ...
                    <?php if ($_SESSION['jenis_user'] == 1) : ?>
                        <li class="nav-item <?= (isset($_GET['page']) && $_GET['page'] == 'user') ? 'menu-open' : '' ?>">
                            <a href="#"
                               class="nav-link <?= (isset($_GET['page']) && $_GET['page'] == 'user') ? 'active' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('app/user/admin') ?>"
                                       class="nav-link <?= (isset($_GET['page']) && $_GET['page'] == 'user' && $_GET['id_jenis'] == 1) ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Administrator</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('app/user/petugas') ?>"
                                       class="nav-link <?= (isset($_GET['page']) && $_GET['page'] == 'user' && $_GET['id_jenis'] == 2) ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Petugas LPSE</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('app/user/vendor') ?>"
                                       class="nav-link <?= (isset($_GET['page']) && $_GET['page'] == 'user' && $_GET['id_jenis'] == 3) ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Vendor</p>
                                    </a>
                                </li>
